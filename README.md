...
1. 下載或 Clone 此專案至本地：
   ```bash
   git clone <repo-url> ai-selector-extension
...
| 欄位 | 說明 | 範例 |
|------|------|------|
| API Base URL | 供應商的 API 基礎位址（含 `/v1`） | `https://api.openai.com/v1` |
| API Key | 向供應商申請的金鑰 | `sk-xxxxxxxx` |
